...
public:
    ...
    void removeNoInicio();
    void contaElementos();
    void removeElemento(string nomeEquipe);
};
...
void lista::removeElemento(string nomeEquipe){
    if(vazia()){
        cout<< "Remoção em lista vazia!" << endl;
    }
    else{
        ...
        while(atual!= NULL and !encontrado){
            if(atual->elenco.nomeEquipe == nomeEquipe){
                encontrado = true;
            }
            else{
                anterior = atual;
    ...
    do {
        try {
            ...
            switch (comando) {
                ...
                case 'x': //remove
                    cin>>nomeEquipe;
                    minhaLista.removeElemento(nomeEquipe);
                    break;
                case 'f': // finalizar
                    // checado no do-while
                    break;
