...
void listadup::removeNoFim()
{
 ...
 void listadup::removePorNome(string nome){
    if (vazia()){
        cout<< "Remoção em lista vazia" << endl;
        return;
    }
...
void listadup::removePorId(int id){
    if(vazia()){
        cout<< "Remoção em lista vazia" << endl;
        return;
    }
    ...
    while(atual != NULL){
        if(atual->acao.identificador == id){
            if(atual == primeiro){
                removeNoInicio();
                return;
            }else if(atual == ultimo){
...
int main()
{
    ...
    do
    {
        try
        {
            ...
            case 'x':
                cin>>nomeAcao;
                minhaLista.removePorNome(nomeAcao);
                break;
            case 'w':
                cin>>id;
                minhaLista.removePorId(id);
                break;
            case 'f': // finalizar
                // checado no do-while
                break;
